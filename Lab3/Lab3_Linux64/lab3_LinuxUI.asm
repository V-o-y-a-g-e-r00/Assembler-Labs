...
;Assemble:	nasm -g -f elf64 lab3_LinuxUI.asm -l lab3_LinuxUI.lst -o lab3_Linux.obj
;Link:		gcc lab3_Linux.obj -g -o lab3_LinuxUI.exe -m64 -fno-pie -no-pie
;Run:		./lab3_LinuxUI.exe
...
UDIV:   ; dx:ax= dword A / word B *** delimoe A v dx:ax     delitel B v bx
	...
	div bx
	mov dx, cx	; dx:ax=A/B
	;mov word [TESTUDIV], ax    ; proverka
	;mov word [TESTUDIV+2], dx  ;        proverka
	ret
